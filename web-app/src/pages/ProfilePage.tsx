        ...
        >
          ...
          >
            <Typography sx={{ fontSize: 18, mb: "40px" }}>
              Welcome back to Cynes Book, {userDetails.username}!
            </Typography>
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
              ...
              <Typography sx={{ fontSize: 14 }}>{userDetails.email}</Typography>
            </Box>
            <Box sx={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
            ...
            <Box sx={{ display: "flex", justifyContent: "space-between", width: "100%" }}>
              ...
              <Typography sx={{ fontSize: 14 }}>{userDetails.city}</Typography>
            </Box>
          </Box>
        </Card>
      ) : (
